...
func (f *fakeDeviceStore) Create(context.Context, uuid.UUID, *domain.Device, store.EventCallback) (*domain.Device, error) { panic("not implemented") }
func (f *fakeDeviceStore) Update(context.Context, uuid.UUID, *domain.Device, []string, bool, devicestore.DeviceStoreValidationCallback, store.EventCallback) (*domain.Device, error) { panic("not implemented") }
func (f *fakeDeviceStore) CreateOrUpdate(context.Context, uuid.UUID, *domain.Device, []string, bool, devicestore.DeviceStoreValidationCallback, store.EventCallback) (*domain.Device, bool, error) { panic("not implemented") }
func (f *fakeDeviceStore) Get(context.Context, uuid.UUID, string) (*domain.Device, error) { panic("not implemented") }
func (f *fakeDeviceStore) List(context.Context, uuid.UUID, devicestore.DeviceListParams) (*domain.DeviceList, error) { panic("not implemented") }
func (f *fakeDeviceStore) Labels(context.Context, uuid.UUID, store.ListParams) (domain.LabelList, error) { panic("not implemented") }
func (f *fakeDeviceStore) Delete(context.Context, uuid.UUID, string, store.EventCallback) (bool, error) { panic("not implemented") }
func (f *fakeDeviceStore) UpdateStatus(context.Context, uuid.UUID, *domain.Device, store.EventCallback) (*domain.Device, error) { panic("not implemented") }
func (f *fakeDeviceStore) GetRendered(context.Context, uuid.UUID, string, *string, string) (*domain.Device, error) { panic("not implemented") }
func (f *fakeDeviceStore) Healthcheck(context.Context, uuid.UUID, []string) error { panic("not implemented") }
func (f *fakeDeviceStore) ProcessAwaitingReconnectAnnotation(context.Context, uuid.UUID, string, *string) (bool, error) { panic("not implemented") }
func (f *fakeDeviceStore) GetLastSeen(context.Context, uuid.UUID, string) (*time.Time, error) { panic("not implemented") }
func (f *fakeDeviceStore) UpdateAnnotations(context.Context, uuid.UUID, string, map[string]string, []string) error { panic("not implemented") }
func (f *fakeDeviceStore) MutateAnnotation(context.Context, uuid.UUID, string, string, func(string) (string, error)) error { panic("not implemented") }
func (f *fakeDeviceStore) UpdateRendered(context.Context, uuid.UUID, string, string, string, string, string, []domain.DependencySyncConfigRefStatus, bool) (string, error) { panic("not implemented") }
func (f *fakeDeviceStore) SetServiceConditions(context.Context, uuid.UUID, string, []domain.Condition, devicestore.ServiceConditionsCallback) error { panic("not implemented") }
func (f *fakeDeviceStore) DecommissionDevice(context.Context, uuid.UUID, string, domain.DeviceDecommission, store.EventCallback) (*domain.Device, error) { panic("not implemented") }
func (f *fakeDeviceStore) OverwriteRepositoryRefs(context.Context, uuid.UUID, string, ...string) error { panic("not implemented") }
func (f *fakeDeviceStore) GetRepositoryRefs(context.Context, uuid.UUID, string) (*domain.RepositoryList, error) { panic("not implemented") }
func (f *fakeDeviceStore) RemoveConflictPausedAnnotation(context.Context, uuid.UUID, store.ListParams) (int64, []string, error) { panic("not implemented") }
func (f *fakeDeviceStore) SetOutOfDate(context.Context, uuid.UUID, string) error { panic("not implemented") }
func (f *fakeDeviceStore) ListConnectivityChanged(context.Context, uuid.UUID, store.ListParams, time.Time) (*domain.DeviceList, error) { panic("not implemented") }
func (f *fakeDeviceStore) GetWithTimestamp(context.Context, uuid.UUID, string) (*domain.Device, error) { panic("not implemented") }
func (f *fakeDeviceStore) Count(context.Context, uuid.UUID, store.ListParams) (int64, error) { panic("not implemented") }
func (f *fakeDeviceStore) UnmarkRolloutSelection(context.Context, uuid.UUID, string) error { panic("not implemented") }
func (f *fakeDeviceStore) MarkRolloutSelection(context.Context, uuid.UUID, store.ListParams, *int) error { panic("not implemented") }
func (f *fakeDeviceStore) CompletionCounts(context.Context, uuid.UUID, string, string, *time.Duration) ([]domain.DeviceCompletionCount, error) { panic("not implemented") }
func (f *fakeDeviceStore) CountByLabels(context.Context, uuid.UUID, store.ListParams, []string) ([]map[string]any, error) { panic("not implemented") }
func (f *fakeDeviceStore) Summary(context.Context, uuid.UUID, store.ListParams) (*domain.DevicesSummary, error) { panic("not implemented") }
func (f *fakeDeviceStore) ListDevicesByServiceCondition(context.Context, uuid.UUID, string, string, store.ListParams) (*domain.DeviceList, error) { panic("not implemented") }
func (f *fakeDeviceStore) SetIntegrationTestCreateOrUpdateCallback(store.IntegrationTestCallback) { panic("not implemented") }
func (f *fakeDeviceStore) CountByOrgAndStatus(context.Context, *uuid.UUID, devicestore.DeviceStatusType, bool) ([]devicestore.CountByOrgAndStatusResult, error) { panic("not implemented") }
...
func newTestHandlerWithDeviceStore(ds devicestore.Store) (*ServiceHandler, *fakeCatalogStore, *fakeEventsService) {
	fakeStore := newFakeCatalogStore()
	fakeEvents := &fakeEventsService{}
	return NewServiceHandler(fakeStore, ds, fakeEvents, logrus.New()), fakeStore, fakeEvents
}
...
func makeContainerAppSpec(t *testing.T, catalog, item, version string, channel *string, appName *string) v1beta1.ApplicationProviderSpec {
	t.Helper()
	container := v1beta1.ContainerApplication{
		AppType: v1beta1.AppTypeContainer,
		Name:    appName,
	}
	err := container.FromCatalogItemRefApplicationProviderSpec(v1beta1.CatalogItemRefApplicationProviderSpec{
...
func makeDeviceWithOsRef(name, catalog, item, version string, channel *string) domain.Device {
	return domain.Device{
		...
		Spec: &domain.DeviceSpec{
			Os: &v1beta1.ImageOrCatalogItemRefSpec{
				CatalogItemRef: &v1beta1.CatalogItemRefSpec{
					Catalog: catalog,
					Item:    item,
					Version: version,
...
func TestGetCatalogItemDeployments(t *testing.T) {
	tests := []struct {
		...
		{
			name:              "When no devices reference the catalog item it should return an empty list",
		...
		{
			name:        "When a device has an OS catalog item ref it should return one deployment",
			catalogName: "my-catalog",
			itemName:    "my-item",
			osDevices: []domain.Device{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.appDevices != nil {
				// Build actual app devices with populated spec for the app test cases
			...
			h, _, _ := newTestHandlerWithDeviceStore(ds)
			...
			require.NotNil(t, result)
			require.Equal(t, apiversioning.QualifiedV1Alpha1, result.ApiVersion)
			require.Equal(t, v1alpha1.CatalogItemDeploymentListKind, result.Kind)
			...
			for _, dep := range result.Items {
				...
				require.Equal(t, apiversioning.QualifiedV1Alpha1, dep.ApiVersion)
				require.Equal(t, v1alpha1.CatalogItemDeploymentKind, dep.Kind)
			}
